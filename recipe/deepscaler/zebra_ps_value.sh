...
exp_name="zebra_ps_value_uniform_0.9_0.7"
...
python3 -m verl.trainer.main_ppo \
    ...
    +adv_predictor.history_length=3 \
    critic.optim.lr=1e-6 \
    +critic.model.style=value_head \
    +critic.model.num_labels=1 \
    +critic.model.num_heads=2 \
    +critic.model.loss_fn2_weight=1.0 \
